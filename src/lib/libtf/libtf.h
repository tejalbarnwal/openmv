...
int libtf_tejuinput(const unsigned char *model_data, float *x, const int input_size, uint8_t* tensor_arena, libtf_parameters_t *params, float *output_data, const int output_size);
