...
// begin regression
STATIC mp_obj_t py_tf_regression_1Din_1Dout(uint n_args, const mp_obj_t *args, mp_map_t *kw_args)
{
    fb_alloc_mark();
    py_tf_alloc_putchar_buffer();
...
STATIC MP_DEFINE_CONST_FUN_OBJ_KW(py_tf_regression_1Din_1Dout_obj, 2, py_tf_regression_1Din_1Dout);
